...
export function Header() {
  ...
  const handleSolutionsAnchorClick = (
    e: React.MouseEvent<HTMLAnchorElement>,
    anchor: string
  ) => {
          ...
          >
            <NavigationMenuList className="gap-8">
              <NavigationMenuItem>
                <NavigationMenuTrigger
                  variant="plain"
                  className="text-sm font-medium text-foreground hover:text-secondary h-auto px-0 py-0 focus-visible:ring-0"
                >
              ...
              <NavigationMenuItem>
                <Link
                  href="/accelerator"
                  className={`${topLevelLinkClass} flex items-center gap-2`}
                >
                  Accelerator
                ...
                <NavigationMenuContent className="right-0 left-auto">
                  <ul className="grid w-[200px] gap-4 p-4">
                    <li>
                      <NavigationMenuLink
                        asChild
                        className={`${dropdownLinkClass} whitespace-nowrap`}
                      >
                        <Link href="/solutions">Hire Us</Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink
                        ...
                        className={`${dropdownLinkClass} whitespace-nowrap`}
                      >
                        <Link href="/community">Become A Sponsor</Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink
                        ...
                        className={`${dropdownLinkClass} whitespace-nowrap`}
                      >
                        <Link href="/accelerator">Apply for Accelerator</Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink
