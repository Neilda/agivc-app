        ...
        <div className="bg-muted rounded-3xl p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button className="inline-flex px-6 py-2 bg-primary text-primary-foreground rounded-full text-sm font-medium hover:bg-primary/90 transition">
                Learn Our Philosophy
              </button>
            </div>

            <div className="bg-secondary/30 rounded-2xl aspect-video flex items-center justify-center">
