      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-balance leading-tight">
            ...
            <span className="underline decoration-foreground decoration-[6px] underline-offset-4">build AI</span>
            <span className="text-foreground">, run AI communities and invest in AI startups</span>
          </h1>
